...
async function updatePrice() {
    try {
        ...
        try {
            ...
            console.log("✅ Đã lấy giá Web.");
        } catch (e) { console.log("❌ Lỗi Web: " + e.message); }

        // 2. LẤY GIÁ SHEET (API v4)
        try {
        ...
        console.log("🚀 XONG!");
    } catch (error) { console.log("Lỗi tổng: " + error.message); }
}
