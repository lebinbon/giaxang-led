...
const createHTML = (vung) => `
    ...
    <head><meta charset='utf-8'><style>
        body { 
            ...
            font-size: 25px; /* Kích thước vừa vặn */
            font-weight: bold; 
            overflow: hidden; 
            white-space: nowrap;
            /* Đổ bóng để nổi bật trên nền trong suốt */
            text-shadow: 2px 2px 3px #000;
            letter-spacing: -0.5px; /* Thu hẹp khoảng cách chữ một chút để đủ chỗ */
        }
        .container { 
            width: 1872px; 
            height: 82px; 
    ...
    <body>
        <div class="container">
            ...
            <span>XĂNG RON 95-III: <span class="price-value">${data.RON95_III}</span></span>
            <span class="separator">|</span>
            
            <span>XĂNG E5 RON 92-II: <span class="price-value">${data.E5}</span></span>
            <span class="separator">|</span>
            
            <span>DẦU DO 0,001S-V: <span class="price-value">${data.DO_001}</span></span>
            <span class="separator">|</span>
            
            <span>DẦU DO 0,05S-II: <span class="price-value">${data.DO_05}</span></span>
        </div>
    </body>
    </html>`;
